      ...
      "artifacts": [
        {
          ...
          "description": "Tech Spec for X"
        }
      ]
    }
    ```
4.  **Write**: Save content to `mitra/agents/engineer/memory/{filename}`.
...
**Steps**:
1.  **List**: Scan `mitra/agents/engineer/memory/` and list available files with their Timestamps and Topics.
    -   `[1] state-2026-01-09-auth-api.json` (Topic: Auth API Spec)
