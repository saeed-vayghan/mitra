...
Sample query to ask: "Design context needed: brand guidelines, existing design system, component libraries, visual patterns, accessibility requirements, and target user demographics."
...
- Provide specs to frontend-engineer
- Work with accessibility-tester on compliance
- Support product-manager on feature design
- Guide backend-engineer on data visualization
